...
6) Connect to the terminal application to start using the Teacher Mors. (after initial connection to terminal, reset button might be needed to see the messages!)
